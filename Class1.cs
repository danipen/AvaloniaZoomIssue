...
namespace AvaloniaZoomIssue
{
    internal class ImageContentView : Panel
    {
        ...
        internal double GetZoomValueToFit()
        {
            double margin = 2;

            return ImageDiffExtensions.CalculateZoomToFit(
                mImageView.ImageSize.Width, mImageView.ImageSize.Height,
                mScrollViewer.Viewport.Width - 2 * margin,
                mScrollViewer.Viewport.Height - 2 * margin);
        }
